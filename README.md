...
### Procedure
1. [Create Gemini API key](https://aistudio.google.com/app/apikey) (if you are re-directed to the page `https://ai.google.dev/gemini-api/docs/available-regions` API is not available for your country yet)
